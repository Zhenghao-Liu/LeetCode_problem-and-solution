[SQL架构](https://github.com/Zhenghao-Liu/LeetCode_problem-and-solution/blob/master/1532.最近的三笔订单/PROBLEM.sql)
...
返回的结果按照 ```customer_name``` **升序**排列。如果排名有相同，则继续按照 ```customer_id``` **升序**排列。如果排名还有相同，则继续按照 ```order_date``` **降序**排列。
